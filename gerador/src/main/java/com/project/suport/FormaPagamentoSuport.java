 ...
 * @author MOISES
 */
public class FormaPagamentoSuport implements InterfaceDao {
    
    private InterfaceDao<FormaPagamento> Dao() {
        InterfaceDao<FormaPagamento> dao = new Dao<>(FormaPagamento.class);
        return dao;
    }

    @Override
    public boolean save(Object entity) {
        return Dao().save((FormaPagamento) entity);
    }

    @Override
    public boolean saveOrUpdate(Object entity) {
        return Dao().saveOrUpdate((FormaPagamento) entity);
    }

    @Override
    public boolean update(Object entity) {
        return Dao().update((FormaPagamento) entity);
    }

    @Override
    public boolean remove(Object entity) {
        return Dao().remove((FormaPagamento) entity);
    }

    @Override
    public boolean merge(Object entity) {
        return Dao().merge((FormaPagamento) entity);
    }
