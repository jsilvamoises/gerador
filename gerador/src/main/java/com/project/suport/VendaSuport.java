 ...
 * @author MOISES
 */
public class VendaSuport implements InterfaceDao {
    
    private InterfaceDao<Venda> Dao() {
        InterfaceDao<Venda> dao = new Dao<>(Venda.class);
        return dao;
    }

    @Override
    public boolean save(Object entity) {
        return Dao().save((Venda) entity);
    }

    @Override
    public boolean saveOrUpdate(Object entity) {
        return Dao().saveOrUpdate((Venda) entity);
    }

    @Override
    public boolean update(Object entity) {
        return Dao().update((Venda) entity);
    }

    @Override
    public boolean remove(Object entity) {
        return Dao().remove((Venda) entity);
    }

    @Override
    public boolean merge(Object entity) {
        return Dao().merge((Venda) entity);
    }
