 ...
 * @author MOISES
 */
public class ContasReceberSuport implements InterfaceDao {
    
    private InterfaceDao<ContasReceber> Dao() {
        InterfaceDao<ContasReceber> dao = new Dao<>(ContasReceber.class);
        return dao;
    }

    @Override
    public boolean save(Object entity) {
        return Dao().save((ContasReceber) entity);
    }

    @Override
    public boolean saveOrUpdate(Object entity) {
        return Dao().saveOrUpdate((ContasReceber) entity);
    }

    @Override
    public boolean update(Object entity) {
        return Dao().update((ContasReceber) entity);
    }

    @Override
    public boolean remove(Object entity) {
        return Dao().remove((ContasReceber) entity);
    }

    @Override
    public boolean merge(Object entity) {
        return Dao().merge((ContasReceber) entity);
    }
