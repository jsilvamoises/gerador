 ...
 * @author MOISES
 */
public class PessoaFisicaSuport implements InterfaceDao {
    ...
    public boolean save(Object entity) {
        return Dao().save((PessoaFisica) entity);
    }

    @Override
    public boolean saveOrUpdate(Object entity) {
        return Dao().saveOrUpdate((PessoaFisica) entity);
    }

    @Override
    public boolean update(Object entity) {
        return Dao().update((PessoaFisica) entity);
    }

    @Override
    public boolean remove(Object entity) {
        return Dao().remove((PessoaFisica) entity);
    }

    @Override
    public boolean merge(Object entity) {
        return Dao().merge((PessoaFisica) entity);
    }
